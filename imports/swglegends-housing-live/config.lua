...
Core3.PlayerObject = {
	AlwaysSafeLogout = false, -- true means all log outs are safe rather than just in private house
	LinkDeadDelay = 180, -- seconds to remain online
}
