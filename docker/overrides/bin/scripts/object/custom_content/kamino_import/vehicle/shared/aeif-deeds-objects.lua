...
ObjectTemplates:addClientTemplate(object_tangible_deed_vehicle_deed_shared_mustafar_panning_droid, "object/tangible/deed/vehicle/shared_mustafar_panning_droid.iff")
...
object_tangible_deed_vehicle_deed_shared_vehicle_deed_swamp_speeder = SharedTangibleObjectTemplate:new {
...
object_tangible_deed_vehicle_deed_shared_t16_deed = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/deed/vehicle_deed/shared_t16_deed.iff"}

ObjectTemplates:addClientTemplate(object_tangible_deed_vehicle_deed_shared_t16_deed, "object/tangible/deed/vehicle_deed/shared_t16_deed.iff")


object_tangible_deed_vehicle_deed_shared_t47_deed = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/deed/vehicle_deed/shared_t47_deed.iff"}

ObjectTemplates:addClientTemplate(object_tangible_deed_vehicle_deed_shared_t47_deed, "object/tangible/deed/vehicle_deed/shared_t47_deed.iff")


object_tangible_deed_vehicle_deed_shared_tcg_republic_gunship_deed = SharedTangibleObjectTemplate:new {
	-- Compatibility template: it supplies the Core3 vehicle-deed behavior
	-- while the client continues to source the Gunship model and skin from MTG.
...
object_tangible_deed_vehicle_deed_shared_twin_pod_cloud_car = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/deed/vehicle_deed/shared_twin_pod_cloud_car.iff"}

ObjectTemplates:addClientTemplate(object_tangible_deed_vehicle_deed_shared_twin_pod_cloud_car, "object/tangible/deed/vehicle_deed/shared_twin_pod_cloud_car.iff")
