...
object_intangible_vehicle_shared_t16_pcd = SharedIntangibleObjectTemplate:new {
	clientTemplateFileName = "object/intangible/vehicle/shared_t16_pcd.iff"}

ObjectTemplates:addClientTemplate(object_intangible_vehicle_shared_t16_pcd, "object/intangible/vehicle/shared_t16_pcd.iff")


object_intangible_vehicle_shared_t47_pcd = SharedIntangibleObjectTemplate:new {
	clientTemplateFileName = "object/intangible/vehicle/shared_t47_pcd.iff"}

ObjectTemplates:addClientTemplate(object_intangible_vehicle_shared_t47_pcd, "object/intangible/vehicle/shared_t47_pcd.iff")


object_intangible_vehicle_shared_twin_pod_cloud_car_pcd = SharedIntangibleObjectTemplate:new {
	clientTemplateFileName = "object/intangible/vehicle/shared_twin_pod_cloud_car_pcd.iff"}

ObjectTemplates:addClientTemplate(object_intangible_vehicle_shared_twin_pod_cloud_car_pcd, "object/intangible/vehicle/shared_twin_pod_cloud_car_pcd.iff")
